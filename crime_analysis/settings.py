...
SECRET_KEY = os.getenv('SECRET_KEY', '@$d)b^%bndei&kx-j78fz^h^1mzajv(pcajot*v_=ng^b1v$n0')
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv('DATABASE_URL', 'postgres://root:password@127.0.0.1:5432/crime_analysis')
    )
}
